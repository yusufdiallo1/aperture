...
> Run `shasum -a 256 Noctura-1.6.dmg` and compare before doing anything else.
...
```bash
cat ~/Library/Containers/com.yusufdiallo.noctura/Data/Library/Logs/Camera-boot.log
```
